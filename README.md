...
- **[Stability Envelope](ca://s?q=Explain_the_Stability_Envelope)** — the region of predictable model behavior across turns  
- **[Runtime Prior](ca://s?q=Explain_the_Runtime_Prior)** — the system‑prompt‑induced distribution that governs model interpretation  
- **[Interpretive State](ca://s?q=Explain_the_Interpretive_State)** — the model’s active internal framing during inference  
